...
export default function Events() {
  ...
  // Render past events content (shared between super_admin and admin)
  ...
  // Super admin sees both tabs, admin only sees past events
  if (!isSuperAdmin) {
    return (
      <Box
        w={"full"}
                ...
                <Field.Root w={"full"} invalid={!!errors.event_description}>
                  <Textarea
                    {...register("event_description", {
                      required:
                        "You cannot proceed without an event description",
                      validate: (input) => {
                        return (
  ...
  // Super admin sees tabs with both upcoming and past events
  return (
    <Box
      w={"full"}
      h={"full"}
